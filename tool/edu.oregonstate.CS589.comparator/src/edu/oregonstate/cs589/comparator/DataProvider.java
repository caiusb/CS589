...
public class DataProvider {
	...
	private final void retrieveTasks() throws IOException {
		...
		tasks.add(new Task(userID, "T05", "Git", rootRepoPath + s + "elasticsearch-slim" + s + ".git", "d17a3d0498c1af2cb3c63d82a28db5113d1a2170"));
		tasks.add(new Task(userID, "T06", "Git", rootRepoPath + s + "SlidingMenu-slim" + s + ".git", "8758b7b7d96f1da4a2f369cf159249c8bd4a464e"));
