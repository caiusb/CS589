...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../data/analysis/RQ4_AllGradesBoxPlot}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../data/analysis/RQ4_AllGradesHistogram}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../data/analysis/RQ4_ParticipantGrades}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../data/analysis/RQ4_AllGrades}
