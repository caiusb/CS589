...
A commit is randomly chosen from the last 5 commits in a project.
...
Their order in which we will apply the treatments will be random for each participant. T
his is done to eliminate the learning effect. 
